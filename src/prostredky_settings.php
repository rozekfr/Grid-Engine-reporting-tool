                ...
                echo "<div class='vlevo'>";
                    echo "<fieldset>";
                        ...
                        echo "<table>";
                            ...
                            echo "<tr><td><input type='checkbox' class='matyldy_AVG' id='matylda2' checked><label for='matylda2'>matylda2</label></td><td><input type='checkbox' class='matyldy_MAX' id='matylda2_MAX' checked><label for='matylda2_MAX'>matylda2_MAX</label></td></tr>";
                            echo "<tr><td><input type='checkbox' class='matyldy_AVG' id='matylda3' checked><label for='matylda3'>matylda3</label></td><td><input type='checkbox' class='matyldy_MAX' id='matylda3_MAX' checked><label for='matylda3_MAX'>matylda3_MAX</label></td></tr>";
                            echo "<tr><td><input type='checkbox' class='matyldy_AVG' id='matylda4' checked><label for='matylda4'>matylda4</label></td><td><input type='checkbox' class='matyldy_MAX' id='matylda4_MAX' checked><label for='matylda4_MAX'>matylda4_MAX</label></td></tr>";
                            echo "<tr><td><input type='checkbox' class='matyldy_AVG' id='matylda5' checked><label for='matylda5'>matylda5</label></td><td><input type='checkbox' class='matyldy_MAX' id='matylda5_MAX' checked><label for='matylda5_MAX'>matylda5_MAX</label></td></tr>";
                            echo "<tr><td><input type='checkbox' class='matyldy_AVG' id='matylda6' checked><label for='matylda6'>matylda6</label></td><td><input type='checkbox' class='matyldy_MAX' id='matylda6_MAX' checked><label for='matylda6_MAX'>matylda6_MAX</label></td></tr>";
                        echo "</table>";
                    echo "</fieldset>";
                echo "</div>";
                echo "<div class='vpravo'>";
                    ...
                    echo "<legend>Scratche</legend>";
                        echo "<table>";
                            ...
                            echo "<tr><td><input type='checkbox' class='scratche_AVG' id='scratch2' checked><label for='scratch2'>scratch2</label></td><td><input type='checkbox' class='scratche_MAX' id='scratch2_MAX' checked><label for='scratch2_MAX'>scratch2_MAX</label></td></tr>";
                            echo "<tr><td><input type='checkbox' class='scratche_AVG' id='scratch3' checked><label for='scratch3'>scratch3</label></td><td><input type='checkbox' class='scratche_MAX' id='scratch3_MAX' checked><label for='scratch3_MAX'>scratch3_MAX</label></td></tr>";
                            echo "<tr><td><input type='checkbox' class='scratche_AVG' id='scratch4' checked><label for='scratch4'>scratch4</label></td><td><input type='checkbox' class='scratche_MAX' id='scratch4_MAX' checked><label for='scratch4_MAX'>scratch4_MAX</label></td></tr>";
                            echo "<tr><td><input type='checkbox' class='scratche_AVG' id='scratch5' checked><label for='scratch5'>scratch5</label></td><td><input type='checkbox' class='scratche_MAX' id='scratch5_MAX' checked><label for='scratch5_MAX'>scratch5_MAX</label></td></tr>";
                            echo "<tr><td><input type='checkbox' class='scratche_AVG' id='scratch6' checked><label for='scratch6'>scratch6</label></td><td><input type='checkbox' class='scratche_MAX' id='scratch6_MAX' checked><label for='scratch6_MAX'>scratch6_MAX</label></td></tr>";
                        echo "</table>";
                    echo "</fieldset>";
                echo "</div>";
                ...
                echo "<div class='vpravo'>";
                    echo "<fieldset>";
                        ...
                        echo "<table>";
                            ...
                            echo "<tr><td><input type='checkbox' class='DS_spoj' id='mem_free' disabled><label for='mem_free'>Velikost volné paměti v [GB]</label></td></tr>";
